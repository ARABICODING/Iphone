...
const buttonElement = document.querySelector("#btnsubmit",".email");
const messageField = document.querySelector("#message",".newsletter");


let btnBackgroundColor = buttonElement.style.backgroundColor;
